...
override PACKAGE_NAME=sm
override PACKAGE_VERSION=0.0
ifndef LCL_PLATFORM
...
ifeq ($(FULL_TARGET),i386-linux)
override COMPILER_UNITDIR+=/usr/lib64/lazarus/packager/units/$(CPU_TARGET)-$(OS_TARGET) .
endif
ifeq ($(FULL_TARGET),i386-go32v2)
override COMPILER_UNITDIR+=/usr/lib64/lazarus/packager/units/$(CPU_TARGET)-$(OS_TARGET) .
endif
